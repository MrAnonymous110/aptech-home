...
namespace lab4AdvanceControl
{
    public partial class Bankschoice : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                lblBranchName.Text = "you must Login first";
            ...
            else
            {
                ...
                lblDateTime.Text = DateTime.Now.Date + "    " + DateTime.Now.DayOfYear ;
            }

            selectStr = "SELECT * FROM BranchesList";
            ...
            PolColorado.PostBackValue = table.Rows[0]["BranchID"].ToString();
        ...
        protected void imgMap_Click(object sender, ImageMapEventArgs e)
        {
            ...
            if (cn.State == ConnectionState.Closed)
                cn.Open();
            string selectStr = string.Format("SELECT * FROM BranchesList WHERE BranchID = {0}", e.PostBackValue);
